...
const PackCarousel = () => {
    return (
        <div>
            <p className="  md:hidden mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Featured Tour</p>
            <Slider className="slider md:hidden container py-5 mx-auto mb-5">
