...
const PackFeatureSection = () => {
    return (

        <section className=" hidden md:block text-gray-700 body-font">
            <div className="container py-5 mx-auto">
                <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Featured Tour</p>
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/3">
                        <div className="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            <img className="object-cover object-center w-full h-56" src="https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2018/12/Kakum-National-Park.jpg" alt="avatar" />
                            ...
                            <div className="flex items-center px-6 py-3 bg-gray-900">
                                ...
                                <h1 className="mx-3 text-lg font-semibold text-white">High</h1>
                            </div>

                            <div className="px-6 py-4">
                                <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Kakum National Park</h1>

                                <p className="py-2 text-gray-700 dark:text-gray-400">Kakum national park is a place that one needs to go for visiting the rainforests of Ghana</p>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 className="px-2 text-sm">Havey Cloth</h1>
                                </div>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 className="px-2 text-sm">Ghana</h1>
                                </div>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                    ...
                                    <h1 className="px-2 text-sm">Packit Tour package</h1>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default PackFeatureSection
